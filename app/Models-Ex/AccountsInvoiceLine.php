...
class AccountsInvoiceLine extends Model
{
    ...
    {
        return $this->belongsTo(AccountsVatRate::class, 'invoice_line_vat_rate');
    }

    public function nominalCode()
    {
        return $this->belongsTo(AccountsNominalCode::class, 'invoice_line_nominal_code');
    }

    public function works()
    {
        return $this->belongsTo(Works::class, 'invoice_line_works_id');
    }
}
