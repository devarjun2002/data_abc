...
class AccountsInvoiceCreditLine extends Model
{
    ...
    {
        return $this->belongsTo(AccountsInvoiceCredit::class, 'invoice_credit_id');
    }

    public function vatRate()
    {
        return $this->belongsTo(AccountsVatRate::class, 'invoice_credit_line_vat_rate');
    }

    public function nominalCode()
    {
        return $this->belongsTo(AccountsNominalCode::class, 'invoice_credit_line_nominal_code');
    }
}
