...
return new class extends Migration
{
    public function up()
    {
        Schema::create('sale_task', function (Blueprint $table) {
            $table->id('sale_task_id');
            $table->integer('sale_id')->nullable();
            $table->smallInteger('sale_task_type')->nullable();
            $table->text('sale_task_name')->nullable();
            $table->smallInteger('sale_task_status')->nullable();
            ...
            $table->smallInteger('sale_task_sort')->nullable();
            $table->smallInteger('sale_task_vendor_notified')->nullable();
            $table->smallInteger('sale_task_buyer_notified')->nullable();
