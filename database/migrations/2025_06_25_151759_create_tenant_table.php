...
return new class extends Migration
{
    public function up()
    {
        Schema::create('tenant', function (Blueprint $table) {
            ...
            $table->smallInteger('tenant_type')->nullable();
            $table->smallInteger('tenant_title')->nullable();
            ...
            $table->smallInteger('tenant_bank_name')->nullable();
            ...
            $table->smallInteger('tenant_online_account')->nullable();
            ...
            $table->smallInteger('tenant_employment_status')->nullable();
            $table->text('tenant_employer_name')->nullable();
            $table->decimal('tenant_income', 10, 2)->nullable();
            $table->smallInteger('tenant_income_frequency')->nullable();
