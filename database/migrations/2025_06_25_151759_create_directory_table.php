...
return new class extends Migration
{
    public function up()
    {
        Schema::create('directory', function (Blueprint $table) {
            ...
            $table->smallInteger('directory_bank_name')->nullable();
            ...
            $table->smallInteger('directory_commission_scheme')->nullable();
            $table->decimal('directory_commission_percentage', 10, 2)->nullable();
            $table->smallInteger('directory_payment_terms')->nullable();
            $table->integer('directory_landlord_contractor')->nullable();
            $table->smallInteger('directory_nominal_code')->nullable();
            $table->smallInteger('directory_vat_rate')->nullable();
            $table->smallInteger('directory_accounts_purposes_only')->nullable();
        });
    }
