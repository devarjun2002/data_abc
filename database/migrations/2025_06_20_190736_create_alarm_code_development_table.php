...
return new class extends Migration
{
    public function up()
    {
        Schema::create('alarm_code_development', function (Blueprint $table) {
            $table->engine = 'InnoDB';
        ...
        DB::statement("ALTER TABLE alarm_code_development ROW_FORMAT=DYNAMIC");
    }

    public function down()
    {
        Schema::dropIfExists('alarm_code_development');
    }
};
