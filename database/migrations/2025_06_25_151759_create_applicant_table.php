...
return new class extends Migration
{
    public function up()
    {
        Schema::create('applicant', function (Blueprint $table) {
            ...
            $table->smallInteger('applicant_type')->nullable();
            $table->integer('applicant_sub_type')->nullable();
            $table->smallInteger('applicant_title')->nullable();
            ...
            $table->smallInteger('applicant_purchase_finance')->nullable();
            $table->smallInteger('applicant_purchase_type')->nullable();
            $table->smallInteger('applicant_purchase_chain')->nullable();
            $table->smallInteger('applicant_purchase_chain_status')->nullable();
            $table->text('applicant_purchase_chain_notes')->nullable();
            $table->smallInteger('applicant_ftb')->nullable();
            $table->smallInteger('applicant_referral_solicitor')->nullable();
            $table->text('applicant_referral_solicitor_notes')->nullable();
            $table->smallInteger('applicant_referral_mortgage')->nullable();
            ...
            $table->decimal('applicant_cash_available', 10, 2)->nullable();
            $table->decimal('applicant_mortgage_available', 10, 2)->nullable();
            $table->date('applicant_pof_date_updated')->nullable();
            $table->smallInteger('applicant_source')->nullable();
            $table->smallInteger('applicant_lead_source')->nullable();
            $table->text('applicant_lead_source_notes')->nullable();
            $table->smallInteger('applicant_referral_valuation_closed')->nullable();
            ...
            $table->smallInteger('applicant_referral_mortgage_closed')->nullable();
