...
return new class extends Migration
{
    public function up()
    {
        Schema::create('accounts_tenant_deposit_charge', function (Blueprint $table) {
            $table->engine = 'InnoDB';
            $table->increments('tenant_deposit_charge_id');
            ...
            $table->decimal('tenant_deposit_charge_amount')->nullable();
            $table->decimal('tenant_deposit_charge_total_amount_paid')->nullable();
        ...
        DB::statement("ALTER TABLE accounts_tenant_deposit_charge ROW_FORMAT=DYNAMIC");
    }
