...
return new class extends Migration
{
    public function up()
    {
        Schema::create('accounts_tenant_charge_recurring', function (Blueprint $table) {
            $table->id('tenant_charge_recurring_id');
            ...
            $table->smallInteger('tenant_charge_recurring_frequency_unit')->nullable();
            ...
            $table->smallInteger('tenant_charge_recurring_suspended')->nullable();
