...
return new class extends Migration
{
    public function up()
    {
        Schema::create('accounts_tenant_deposit_charge_payment', function (Blueprint $table) {
            $table->engine = 'InnoDB';
            $table->increments('tenant_deposit_charge_payment_id');
            $table->date('tenant_deposit_charge_payment_date')->nullable();
            $table->decimal('tenant_deposit_charge_payment_amount')->nullable();
        ...
        DB::statement("ALTER TABLE accounts_tenant_deposit_charge_payment ROW_FORMAT=DYNAMIC");
    }
