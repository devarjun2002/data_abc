...
return new class extends Migration
{
    public function up()
    {
        Schema::create('calendar_event', function (Blueprint $table) {
            ...
            $table->tinyInteger('calendar_event_time_off_linked_sickness')->nullable();
            $table->tinyInteger('calendar_event_bulk_email')->nullable();
        ...
        DB::statement("ALTER TABLE calendar_event ROW_FORMAT=DYNAMIC");
    }
