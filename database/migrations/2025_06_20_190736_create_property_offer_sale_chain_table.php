...
return new class extends Migration
{
    public function up()
    {
        Schema::create('property_offer_sale_chain', function (Blueprint $table) {
            $table->engine = 'InnoDB';
            $table->increments('property_offer_sale_chain_id');
            ...
            $table->decimal('property_offer_sale_chain_sale_price')->nullable();
        ...
        DB::statement("ALTER TABLE property_offer_sale_chain ROW_FORMAT=DYNAMIC");
    }
