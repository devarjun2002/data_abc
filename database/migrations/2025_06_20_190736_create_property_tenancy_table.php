...
return new class extends Migration
{
    public function up()
    {
        Schema::create('property_tenancy', function (Blueprint $table) {
            $table->engine = 'InnoDB';
            $table->increments('property_tenancy_id');
            ...
            $table->decimal('property_tenancy_size')->nullable();
            $table->tinyInteger('property_tenancy_size_unit')->nullable();
            $table->decimal('property_tenancy_rent')->nullable();
            $table->tinyInteger('property_tenancy_rent_frequency')->nullable();
            $table->decimal('property_tenancy_erv')->nullable();
        ...
        DB::statement("ALTER TABLE property_tenancy ROW_FORMAT=DYNAMIC");
    }
