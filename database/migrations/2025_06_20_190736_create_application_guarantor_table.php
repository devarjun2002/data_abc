...
return new class extends Migration
{
    public function up()
    {
        Schema::create('application_guarantor', function (Blueprint $table) {
            $table->engine = 'InnoDB';
            $table->increments('application_guarantor_id');
