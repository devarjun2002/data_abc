...
return new class extends Migration
{
    public function up()
    {
        Schema::create('accounts_bacs_file', function (Blueprint $table) {
            ...
            $table->decimal('bacs_file_amount')->nullable();
            ...
            $table->decimal('bacs_file_vat_amount')->nullable();
            $table->tinyInteger('bacs_file_exported')->nullable();
            $table->dateTime('bacs_file_date_created')->nullable();
            $table->integer('bacs_file_created_by')->nullable();
        });
        DB::statement("ALTER TABLE accounts_bacs_file ROW_FORMAT=DYNAMIC");
    }
