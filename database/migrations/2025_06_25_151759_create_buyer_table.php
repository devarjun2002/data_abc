...
return new class extends Migration
{
    public function up()
    {
        Schema::create('buyer', function (Blueprint $table) {
            ...
            $table->smallInteger('buyer_type')->nullable();
            $table->smallInteger('buyer_title')->nullable();
            ...
            $table->smallInteger('buyer_bank_name')->nullable();
            ...
            $table->smallInteger('buyer_online_account')->nullable();
            ...
            $table->smallInteger('buyer_source')->nullable();
        });
    }
