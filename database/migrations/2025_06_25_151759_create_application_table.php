...
return new class extends Migration
{
    public function up()
    {
        Schema::create('application', function (Blueprint $table) {
            ...
            $table->smallInteger('application_length_of_stay')->nullable();
            ...
            $table->smallInteger('application_bank_name')->nullable();
            ...
            $table->smallInteger('application_type')->nullable();
            ...
            $table->smallInteger('application_accountant_title')->nullable();
            ...
            $table->smallInteger('application_solicitor_title')->nullable();
            ...
            $table->smallInteger('application_trade2_title')->nullable();
            ...
            $table->smallInteger('application_trade_title')->nullable();
            ...
            $table->smallInteger('application_body_type')->nullable();
            ...
            $table->smallInteger('application_applicant_email_reminders')->nullable();
            $table->smallInteger('application_holding_deposit_paid')->nullable();
            $table->smallInteger('application_proceed')->nullable();
            $table->smallInteger('application_can_physically_view')->nullable();
        });
    }
