...
return new class extends Migration
{
    public function up()
    {
        Schema::create('calendar_event_viewing', function (Blueprint $table) {
            $table->id('calendar_event_viewing_id');
            ...
            $table->decimal('calendar_event_viewing_ptp', 10, 2)->nullable();
            $table->smallInteger('calendar_event_viewing_confidence_level')->nullable();
            $table->text('calendar_event_viewing_public_notes')->nullable();
            $table->text('calendar_event_viewing_private_notes')->nullable();
            $table->smallInteger('calendar_event_viewing_type')->nullable();
            $table->smallInteger('calendar_event_viewings_referral_solicitor')->nullable();
            $table->smallInteger('calendar_event_viewings_referral_mortgage')->nullable();
            $table->smallInteger('calendar_event_viewings_referral_valuation')->nullable();
