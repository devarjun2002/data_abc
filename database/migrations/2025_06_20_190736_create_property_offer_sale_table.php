...
return new class extends Migration
{
    public function up()
    {
        Schema::create('property_offer_sale', function (Blueprint $table) {
            $table->engine = 'InnoDB';
            $table->increments('property_offer_sale_id');
            $table->integer('property_offer_sale_property')->nullable();
            $table->decimal('property_offer_sale_price')->nullable();
            $table->tinyInteger('property_offer_sale_finance')->nullable();
            $table->tinyInteger('property_offer_sale_mortgage_deposit')->nullable();
        ...
        DB::statement("ALTER TABLE property_offer_sale ROW_FORMAT=DYNAMIC");
    }
